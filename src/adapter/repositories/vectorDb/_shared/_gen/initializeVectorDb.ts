...
export const initializeVectorDb = async (): Promise<void> => {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'action_plan') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'action_plan_append_sheet_to_spreadsheet') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'action_plan_click') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'action_plan_collect_data') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'action_plan_create_spreadsheet') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'action_plan_observe_web_page') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'collected_data') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'spreadsheet') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'spreadsheet_sheet') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'user_request') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'web_page') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'web_page_element') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'web_page_element_page_link') === undefined) {
  ...
  if (getAllCollectionsResult.collections.find((collection) => collection.name === 'web_page_element_text') === undefined) {
